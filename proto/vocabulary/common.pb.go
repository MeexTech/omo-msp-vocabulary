...
func (m *StatisticInfo) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (*VNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_138760f71682afbb, []int{12}
}
...
type ReplyStatistic struct {
	...
	Pages                uint32           `protobuf:"varint,6,opt,name=pages,proto3" json:"pages,omitempty"`
	List                 []*StatisticInfo `protobuf:"bytes,11,rep,name=list,proto3" json:"list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*ReplyStatistic) Descriptor() ([]byte, []int) {
	return fileDescriptor_138760f71682afbb, []int{13}
}
...
func (m *ReplyStatistic) GetTotal() uint32 {
	if m != nil {
		return m.Total
	}
	return 0
...
func (m *ReplyStatistic) GetPages() uint32 {
	if m != nil {
		return m.Pages
	}
	return 0
...
var fileDescriptor_138760f71682afbb = []byte{
	...
	,
}
